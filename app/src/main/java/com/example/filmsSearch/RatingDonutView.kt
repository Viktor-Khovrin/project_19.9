...
class RatingDonutView @JvmOverloads constructor(context: Context, attributeSet: AttributeSet? = null) : View(context, attributeSet) {
    ...
    override fun onMeasure(widthMeasureSpec: Int, heightMeasureSpec: Int){
        ...
        val chosenWidth = chooseDimention(widthMode,widthSize)
        val chosenHeight = chooseDimention(heightMode,heightSize)
    ...
    private fun chooseDimention(mode: Int, size: Int) =
        when (mode) {
